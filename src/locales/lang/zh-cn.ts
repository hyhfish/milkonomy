export default {
  ...
  "多步产量修正": "多步产量修正",
  "#多步产量修正提示": "默认情况下，若某个物品既是工作流中某步的产物、又作为后续非相邻步骤的原料，跨步消耗的部分会按市场价补齐而不占用上游工时，导致多步产量偏高。打开后会按全局物料平衡重新分配各步工时，结果更贴近实际可达产量。",
  ...
  "更新日志": "更新日志",
  "当前版本": "当前版本",
  "仅记录功能变更，不记录部署相关改动": "仅记录功能变更，不记录部署相关改动",
  ...
  // 开源公告
  "开源公告": "开源公告",
  "#开源公告": "Milkonomy 现已完全开源！欢迎 Star、Fork 和参与贡献。",
  "关闭": "关闭",
