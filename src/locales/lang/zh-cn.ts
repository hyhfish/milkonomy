export default {
  ...
  // 英灵殿
  "英灵殿": "英灵殿",
  "纪念那些曾经在游戏中奋战，如今已离开的玩家们": "纪念那些曾经在游戏中奋战，如今已离开的玩家们",
  "这里纪念着因各种原因离开游戏的玩家：": "这里纪念着因各种原因离开游戏的玩家：",
  "提名入殿": "提名入殿",
  "封弊者": "封弊者",
  "赌徒": "赌徒",
  "远行者": "远行者",
  "逝者": "逝者",
  "因违反游戏规则被封禁": "因违反游戏规则被封禁",
  "因赌博飞升而退坑": "因赌博飞升而退坑",
  "因生活原因主动退坑": "因生活原因主动退坑",
  "原因": "原因",
  "专属称号": "专属称号",
  ...
  "上香成功": "上香成功",
  "上香失败": "上香失败",
  "您已经为此人上过香了": "您已经为此人上过香了",
  "您今天已经上过香了": "您今天已经上过香了",
  "上香规则：每天可以上香一次，可选择为任意一位玩家上香": "上香规则：每天可以上香一次，可选择为任意一位玩家上香",

  // 冻结横幅
  "#暂停公告": "因违反游戏政策，本站作者及多位朋友的账号已被封禁。Milkonomy 将暂停服务至 11 月 4 日，期间仅保留英灵殿页面，用以纪念那些因各种原因离开游戏的玩家们。感谢大家一直以来的支持与陪伴。"
